...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240916102446_FixMultipleCascadePathsForReviews2")]
    partial class FixMultipleCascadePathsForReviews2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.BoardGameNight", b =>
                {
                    b.Property<int>("BoardGameNightId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoardGameNightParticipants", b =>
                {
                    b.HasOne("Domain.BoardGameNight", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.BoardGameNight", b =>
                {
                    b.HasOne("Domain.Person", "Organizer")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Review", b =>
                {
                    b.HasOne("Domain.BoardGameNight", "BoardGameNight")
                        .WithMany("Reviews")
                        .HasForeignKey("BoardGameNightId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Person", "Reviewer")
                        .WithMany("Reviews")
